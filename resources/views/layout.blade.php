    ...
    <html lang="en">
      <head>
        ...
        <title>@yield('title', 'Laravel 2242742')</title>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">@yield('encabezado', 'Inventory App - 2242742')</a>
    ...
    <div class="container">
    <h1>@yield('encabezado', 'Inventory App - 2242742')</h1>
        @yield('content')
    </div>
</main>
</div>
